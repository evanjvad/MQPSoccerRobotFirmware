...
// <o> Length of one timer tick in uS <0-4294967295>
// <id> timer_tick
#ifndef CONF_TC1_TIMER_RC_TICK
#define CONF_TC1_TIMER_RC_TICK 1000
#endif
// </h>
...
// <e> Event Output Enable
// <id> timer_event_output_wave
#ifndef CONF_TC1_EVENT_OUTPUT_WAVE
#define CONF_TC1_EVENT_OUTPUT_WAVE 0
#endif

// <o> Length of one timer RA tick in uS <0-4294967295>
// <id> timer_ra_tick
#ifndef CONF_TC1_TIMER_RA_TICK
#define CONF_TC1_TIMER_RA_TICK 500
#endif
//</e>
...
// RB register set to 0
#ifndef CONF_TC1_RB
#define CONF_TC1_RB 0
#endif

// Clock set not invert
#ifndef CONF_TC1_CLKI
#define CONF_TC1_CLKI 0
#endif

// The clock is not gated by an external signal.
#ifndef CONF_TC1_BURST
#define CONF_TC1_BURST TC_CMR_BURST_NONE
#endif
...
#ifndef CONF_TC1_RA
#define CONF_TC1_RA (uint32_t)((float)CONF_TC1_TIMER_RA_TICK * CONF_TC1_CLKS_FREQUENCY / 1000000.f)
#endif

#ifndef CONF_TC1_RC
#define CONF_TC1_RC (uint32_t)((float)CONF_TC1_TIMER_RC_TICK * CONF_TC1_CLKS_FREQUENCY / 1000000.f)
#endif

#ifndef CONF_TC1_CMR_REG_VAL
#define CONF_TC1_CMR_REG_VAL                                                                                           \
	(TC_CMR_TCCLKS(CONF_TC1_TCCLKS) | CONF_TC1_CLKI | TC_CMR_BURST(CONF_TC1_BURST)                                     \
	 | TC_CMR_CAPTURE_ETRGEDG(CONF_TC1_ETRGEDG) | (CONF_TC1_ABETRG << TC_CMR_CAPTURE_ABETRG_Pos)                       \
	 | (((~CONF_TC1_EVENT_OUTPUT_WAVE) & CONF_TC1_CPCTRG) << 14) | ((CONF_TC1_EVENT_OUTPUT_WAVE << 15) & TC_CMR_WAVE)  \
	 | (2 << 13) /* WAVSEL = 10 */                                                                                     \
	 | TC_CMR_WAVE)
#endif

#ifndef CONF_TC1_TICKS_PER_US
#define CONF_TC1_TICKS_PER_US 0
#endif
