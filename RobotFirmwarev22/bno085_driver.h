...
extern uint spec_MaxCargoPlusHeaderWrite;
extern uint spec_MaxCargoPlusHeaderRead;
extern uint spec_MaxTransferWrite;
extern uint spec_MaxTransferRead;
extern uint spec_SHTPVersion;
	
extern uint valid_channels[MAXIMUM_CHANNELS];
